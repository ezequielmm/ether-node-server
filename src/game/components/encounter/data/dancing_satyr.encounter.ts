    ...
    stages: [
        {
            ...
            buttons: [
                {
                    //aka option 1
                    text: 'A: Dance with the Satyr [Lose 10 Max HP, Start each combat with 1 Resolve]',
                    nextStage: 1,
                    effects: [{ kind: 'hp_max', amount: '-10' }],
                },
                {
                    //aka option 2
                    text: 'B: Decline the Offer [Leave]',
                    nextStage: 2,
                    effects: [],
                },
            ],
        },
        {
            ...
            buttons: [
                {
                    //aka option 3
                    text: 'A: Continue Dancing [Lose 10 more Max HP, upgrade Trinket to 2 Resolve]',
                    nextStage: 3,
                    effects: [{ kind: 'hp_max', amount: '-10' }],
                },
                {
