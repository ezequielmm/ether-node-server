    ...
    stages: [
        {
            ...
            buttons: [
                {
                    text: 'A: Try to decode the runes', // aka option 1
                    nextStage: 1,
                    effects: [],
                },
                {
        ...
        },
        {
            ...
            buttons: [
                {
                    text: 'A: Touch the Runes [Become Imbued. Start next combat with 2 Fatigue.]', // aka option 3
                    nextStage: 3,
                    effects: [{ kind: 'fatigue' }, { kind: 'imbued' }],
                },
                {
                    text: 'B: Step Away [Start next combat with Feeble]', // aka option 4
                    nextStage: 4,
                    effects: [{ kind: 'feeble' }],
                },
            ],
