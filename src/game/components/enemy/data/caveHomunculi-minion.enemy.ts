...
const BasicIntents: EnemyAction = {
    options:[
        ...
        { id: 6, probability: 0.3, cooldown: 0, intents: [EB.callForReinforcements([moldPolypMinionData.enemyId], EB.CALL_FOR_REINFORCEMENTS)] },
    ]
}
...
const AdvancedIntents: EnemyAction = {
    options: [
        ...
        { id: 10, probability: 0.1,  cooldown: 0, intents: [EB.callForReinforcements([moldPolypMinionData.enemyId], EB.CALL_FOR_REINFORCEMENTS)] },
